  ...
  const listarAsistencia = async () => {
    if (id) {
      ...
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_CLIENT_URL}/gestion/asistencias/detalles/${id}`
      );
      if (res.data) {
        ...
        <div>
          ...
          <div className="hstack gap-2 ">
            ...
            <Box component="div" sx={{ marginBottom: 2 }}>
              ...
              <Typography variant="body" sx={{ fontSize: 18 }}>
                {
                  asistencia?.alumnoxcursoxdivision?.cursoxdivision?.curso
                    ?.nombre
                }{" "}
                {
                  asistencia?.alumnoxcursoxdivision?.cursoxdivision?.division
                    ?.division
                }
              </Typography>
            </Box>

...
import { Box, Button, Autocomplete, Container, FormControl, Paper, Table, TableBody, TableContainer, TableHead, TableRow, TextField, Typography } from "@mui/material";
    ...
    return (
        <Layout>
            ...
            <div>
                ...
                {
                    !cargando && preanalitico.length === 0 && <Typography variant='h5' sx={{ textAlign: 'center' }}>No hay informacion disponible</Typography>
                }
                {
                    cargando && (

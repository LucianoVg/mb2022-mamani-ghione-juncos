...
async function main() {
  ...
  // })
  // // console.log(alumnos);
  // const materias1 = await prisma.materiaxcursoxdivision.findMany({
  //   include: {
  //     materia: true
  //   },
  //   where: {
  ...
  //   }
  // })
  // const materias2 = await prisma.materiaxcursoxdivision.findMany({
  //   include: {
  //     materia: true
  //   },
  //   where: {
  ...
  // const materias3 = await prisma.materiaxcursoxdivision.findMany({
  //   include: {
  //     materia: true
  //   },
  //   where: {
